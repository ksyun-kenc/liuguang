...
/* Define the SDL 2.0.16 renderer structure */
#define SDL_HAVE_YUV 1
struct SDL_Renderer_2_0_16 {
  const void* magic;
  ...
  int (*UpdateTextureYUV)(SDL_Renderer* renderer,
                          ...
                          const Uint8* Vplane,
                          int Vpitch);
  int (*UpdateTextureNV)(SDL_Renderer* renderer,
                         SDL_Texture* texture,
                         const SDL_Rect* rect,
                         const Uint8* Yplane,
                         int Ypitch,
...
/* Define the SDL 2.0.18 renderer structure */
struct SDL_Renderer_2_0_18 {
  const void* magic;
  ...
  int (*QueueCopyEx)(SDL_Renderer* renderer,
                     ...
                     const SDL_FPoint* center,
                     const SDL_RendererFlip flip);
  int (*QueueGeometry)(SDL_Renderer* renderer,
                       SDL_RenderCommand* cmd,
                       SDL_Texture* texture,
                       const float* xy,
                       int xy_stride,
...
/* Define the SDL 2.0.20 renderer structure */
struct SDL_Renderer_2_0_20 {
  const void* magic;
...
/* Define the SDL 2.0.22 - 2.24.1 renderer structure */
struct SDL_Renderer_2_0_22 {
  const void* magic;
